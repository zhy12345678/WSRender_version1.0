...
"""
import numpy as np
from roboticstoolbox import SerialLink, Link, DHLink
...
def BuildOneRobot(*args):
    ...
    if opt['type'] == 'Articulated':
        ...
        Robot = SerialLink([L1, L2, L3, L4, L5, L6],name='Articualted')
        #Robot.qlim = np.deg2rad([[45, 135], [-45, 45], [-120, 0], [-180, 180], [20, 160], [-70, 70]])
        Robot.links[0].qlim = np.deg2rad([45, 135])
        Robot.links[1].qlim = np.deg2rad([-45, 45])
        Robot.links[2].qlim = np.deg2rad([-120, 0])
        Robot.links[3].qlim = np.deg2rad([-180, 180])
        Robot.links[4].qlim = np.deg2rad([20, 160])
        Robot.links[5].qlim = np.deg2rad([-70, 70])
        N_Dof = 6
        ...
        Robot = SerialLink([L1, L2, L3, L4, L5, L6],name='Spherical')
      #  Robot.qlim = np.deg2rad([[-45, 45], [45, 135], [0.20 / deg, 0.40 / deg], [-180, 180], [20, 160], [-70, 70]])
        Robot.links[0].qlim = np.deg2rad([-45, 45])
        Robot.links[1].qlim = np.deg2rad([45, 135])
        Robot.links[2].qlim = np.deg2rad([0.20 / deg, 0.40 / deg])
        Robot.links[3].qlim = np.deg2rad([-180, 180])
        Robot.links[4].qlim = np.deg2rad([20, 160])
        Robot.links[5].qlim = np.deg2rad([-70, 70])
        ...
        L1 = RevoluteDH(d=0.20, a=0, alpha=0, **{'modified': True})
        L2 = DHLink(theta=0, alpha=-np.pi / 2, a=0, **{'modified': True})
        L3 = DHLink(theta=0, alpha=-np.pi / 2, a=0, **{'modified': True})
        L4 = RevoluteDH(d=0, a=0, alpha=np.pi / 2, **{'modified': True})
        L5 = RevoluteDH(d=0, a=0, alpha=0, **{'modified': True})
        ...
        # Set joint limits for each DHLink
        Robot.links[0].qlim = np.deg2rad([0, 180])
        Robot.links[1].qlim = np.deg2rad([-180, 180])
        Robot.links[2].qlim = np.deg2rad([-180, 180])
        Robot.links[3].qlim = np.deg2rad([45, 135])
        Robot.links[4].qlim = np.deg2rad([-180, 180])
        Robot.links[5].qlim = np.deg2rad([-180, 180])
        N_Dof = 6
        ...
        Robot = SerialLink([L1, L2, L3, L4, L5, L6],name = 'Cartesian')
      #  Robot.qlim = np.deg2rad([[-180, 180], [-180, 180], [-120, 0], [-180, 180], [-180, 180], [-180, 180]])
        Robot.links[0].qlim = np.deg2rad([-180, 180])
        Robot.links[1].qlim = np.deg2rad([-180, 180])
        Robot.links[2].qlim = np.deg2rad([-120, 0])
        Robot.links[3].qlim = np.deg2rad([-180, 180])
        Robot.links[4].qlim = np.deg2rad( [-180, 180])
        ...
        L1 = DHLink(a=0, d=0, alpha=0)
        L2 = DHLink(a=0, d=0, alpha=-np.pi / 2)
        L3 = DHLink(a=Length1, d=0, alpha=0)
        L4 = DHLink(a=Length2, d=0.1506, alpha=np.pi / 2)
        L5 = DHLink(a=0, d=0, alpha=-np.pi / 2)
        L6 = DHLink(a=0, d=0, alpha=np.pi / 2)

        Robot = SerialLink([L1, L2, L3, L4, L5, L6], name='dVRK')
        # Set joint limits for each DHLink
        Robot.links[0].qlim = np.deg2rad([-40, 40])
        Robot.links[1].qlim = np.deg2rad([-65, 65])
        Robot.links[2].qlim = np.deg2rad([-15, 15])
        Robot.links[3].qlim = np.deg2rad([-50, 50])
        Robot.links[4].qlim = np.deg2rad([-50, 50])
        Robot.links[5].qlim = np.deg2rad([-35, 35])
